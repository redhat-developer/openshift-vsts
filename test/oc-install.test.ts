...
describe('InstallHandler', function() {
    ...
    describe('#ocBundleURL', function() {        
        ...
        // it('check if getReleaseByTag is called correctly', async function() {
        //     // const args = {
        //     //     owner: 'openshift',
        //     //     repo: 'origin',
        //     //     tag: 'foo'
        ...
        //     const oktoStub = sandbox.stub(octokit.repos, 'getReleaseByTag').rejects();
        //     await InstallHandler.ocBundleURL('foo', 'Linux');
        //     sandbox.assert.calledOnce(oktoStub);
        // });
    });
